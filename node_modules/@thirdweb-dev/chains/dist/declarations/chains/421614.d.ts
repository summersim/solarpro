declare const _default: {
    ...
    readonly rpc: readonly ["https://arbitrum-sepolia.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://421614.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://sepolia-rollup.arbitrum.io/rpc"];
