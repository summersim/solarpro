...
import { F as FormFieldWithIconButton, Q as QRCode, s as safeChainIdToSlug, w as wait, b as WalletLogoSpinner, H as HeadlessConnectUI, d as defaultWallets, S as ScanScreen, C as ConnectingScreen, W as WCOpenURI, G as GetStartedScreen } from './safeChainSlug-4187a1bc.browser.esm.js';
    ...
    children: [/*#__PURE__*/jsxs(Container, {
      ...
      children: [/*#__PURE__*/jsx(Img, {
        ...
        children: [/*#__PURE__*/jsxs(Container, {
          ...
          }), !props.hideDisconnect && /*#__PURE__*/jsx(ToolTip, {
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./safeChainSlug-4187a1bc.browser.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./safeChainSlug-4187a1bc.browser.esm.js').then(function (n) { return n.T; });
...
function useMetamask() {
  ...
  return useCallback(async options => {
    const {
      metamaskWallet
    } = await import('./safeChainSlug-4187a1bc.browser.esm.js').then(function (n) { return n.h; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./safeChainSlug-4187a1bc.browser.esm.js').then(function (n) { return n.g; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-c1323147.browser.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-b55b4a1b.browser.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-5ed4344b.browser.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./safeChainSlug-4187a1bc.browser.esm.js').then(function (n) { return n.i; });
